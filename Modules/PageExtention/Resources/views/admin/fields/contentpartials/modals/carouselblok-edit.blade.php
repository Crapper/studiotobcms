<div class="modal fade" id="BewerkContentImageBlokModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body createmodal">
                ...
                <button  id="edit-image-blok" class="btn btn-primary btn-flat">{{ trans('core::core.button.update') }}</button>
